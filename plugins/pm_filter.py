...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('💠 UᎮDΛTΞS 💠', url='https://t.me/malayalammoviezz_TG')
            ],[      
        ...
        buttons= [[
            InlineKeyboardButton('♥️ SԾUᏒCΞ ♥️', url='https://github.com/navaneethrkrishna007/Auto-Filter-Bot')
            ],[
            InlineKeyboardButton('🏠 𝗛𝗼𝗺𝗲 🏠', callback_data='start'),
...
async def advantage_spell_chok(msg):
    ...
    if not movielist:
        k = await msg.reply("I couldn't find anything related to that. Check your spelling @imdbbot")
        await asyncio.sleep(8)
        await k.delete()
        return
